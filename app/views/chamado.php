...
<head>
    ...
    body {
        ...
        padding: 0;
        font-size: 16px;
        /* Garantir que o texto padrão tenha um tamanho confortável */
        overflow-x: hidden;
    ...
    .box {
        ...
        width: 80%;
        max-width: 400px;
        /* Máxima largura para telas grandes */
        margin-top: 126px;
        /* Adicionando mais margem no topo */
    }
    ...
    .inputUser {
        ...
        color: white;
        font-size: 16px;
        /* Garante que o tamanho da fonte seja adequado para evitar zoom */
        width: 100%;
        letter-spacing: 2px;
    }
    ...
    #service option {
        color: #000000;
        /* Texto preto para as opções quando o menu estiver aberto */
    ...
    #service:focus {
        outline: none;
        border-color: #009688;
        /* Cor do contorno ao focar no campo */
    }

    .inputBox {
        position: relative;
        margin-bottom: 60px; /* Aumentado de 15px para 25px */
    }
